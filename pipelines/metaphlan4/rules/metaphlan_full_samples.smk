...
rule MetaPhlAn:
    ...
    resources:
        ...
        nodetype = "thinnode",
    output:
        bowtieindex=OUT_DIR + "{barcode}/{barcode}_NonHuman_Combined_Subsampled_" + "full" + "_bowtie2.bz2",
        txt=OUT_DIR + "{barcode}/{barcode}_NonHuman_Combined_Subsampled_" + "full" + "_profile.txt",
    log:
...
rule MergeMetaPhlAnProfiles:
    ...
    input:
        files=expand(
            OUT_DIR + "{barcode}/{barcode}_NonHuman_Combined_Subsampled_" + "full" + "_profile.txt",
    ...
    resources:
        ...
        nodetype = "thinnode",
    output:
        txt=OUT_DIR + "MetaPhlAn_4.1.0_Combined_NonHuman_Subsampled_" + "full" + "_profile.txt",
    # envmodules:
    #     "tools",
    #     "metaphlan/4.0.3",
    shell:
