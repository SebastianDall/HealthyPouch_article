...
#PBS -N 2024-10-24_arg_contigs
### Output files (comment out the next 2 lines to get the job name used instead)
#PBS -e logs/arg_contigs_241024
#PBS -o logs/arg_contigs_241024
...
mkdir -p logs/arg_contigs_241024

snakemake -s _pipelines/arg_contigs/workflows/Snakefile --use-conda --cores 40 --keep-going --latency-wait 60
