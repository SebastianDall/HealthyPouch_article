...
## Abstract
### Background and Aims
Fecal microbiota transplantation (FMT) from healthy donors with a normally functioning colon has limited clinical effect in the treatment of chronic pouchitis. However, a normally functioning ileal pouch-anal anastomosis (IPAA) physiology differs from individuals with a healthy intact colon. We aimed to investigate the microbial characteristics of patients with a normally functioning IPAA (HealthyPouch) compared with chronic pouchitis (SickPouch), Ulcerative Colitis (UC), and a healthy intact colon microbiome (NormalGut). Furthermore, we investigated how repeated antibiotic use influences antimicrobial resistance on a bacterial genome level.

### Methods
Fecal samples from 190 participants were collected; HealthyPouch (n=38), SickPouch (n=37), UC (n=23), and NormalGut (n=92) and sequenced with Illumina and taxonomically profiled. Samples from HealthyPouch, SickPouch, and NormalGut were also long-read sequenced using Oxford Nanopore Technologies for reconstruction of 12,282 metagenome-assembled genomes (MAGs). DNA methylation motifs were used for plasmid-host association.

### Results
The HealthyPouch microbiome is distinct from both the UC, NormalGut, and SickPouch microbiome. E. coli MAGs in the SickPouch (n=21) microbiome had significantly higher co-occurring ciprofloxacin resistance mutations in the gyrA and parC genes, compared to both HealthyPouch (n=26; BH adjusted p<0.05) and NormalGut (n=40; BH adjusted p<0.05). Using DNA methylation pattern, three plasmids were associated with E. coli carrying extended-spectrum beta lactamase genes.
